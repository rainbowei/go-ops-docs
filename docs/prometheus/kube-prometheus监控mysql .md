###### 1  helm安装mysql-exopter：

- heml地址：https://github.com/prometheus-community/helm-charts

```
git clone   https://github.com/prometheus-community/helm-charts
cd prometheus-helm-charts-main/charts/prometheus-mysql-exporter
```
...
- 修改相关values.yaml文件
  ...
  mysql:
    db: ""
    host: "eks-mysql.test20.bitget.tools"      //修改为要监控的mysql主机地址
    param: ""
    pass: "YT=SDQ#YxLWsSi)$O$F]V0tOW6U1+KzV"   //修改为要监控的mysql密码
    port: 3306
    protocol: ""
    user: "test_public"                         修改为要监控的mysql 用户
